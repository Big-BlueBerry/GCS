    ...
    public partial class Dot
    {
        ...
        public class DotOnShapeRule : ShapeRule
        {
            ...
            protected void RecalcRatio()
            {
                ...
                if (parent is Circle)
                {
                    Circle circle = parent as Circle;
                ...
                {
                    LineLike line = parent as LineLike;
            ...
            protected override void Fix()
            {
                ...
                {
                    LineLike line = parent as LineLike;
                    Vector2 p1 = line.Point1;
                    Vector2 p2 = line.Point2;
        ...
        public class DotOnIntersectionRule : ShapeRule
        {
            ...
            {
                Dot dot = Shape as Dot;
                Shape p1 = Shape.Parents[0];
                Shape p2 = Shape.Parents[1];
                Vector2[] vs = Geometry.GetIntersect(p1, p2);
